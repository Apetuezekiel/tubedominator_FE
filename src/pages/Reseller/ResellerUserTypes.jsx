        ...
        <div>
          ...
          <div className="rounded-md bg-white p-5">
            ...
            <div className="flex flex-wrap -mx-2">
              <Folder route={"reseller-users-all"} userType={"All"} />
              <Folder route={"reseller-users-bundle"} userType={"Bundle"} />
              <Folder route={"reseller-users-premium"} userType={"Premium"} />
            </div>
          </div>
        </div>
      </div>
...
export default ResellerUserTypes;
