  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 rounded-md overflow-hidden min-h-screen">
      ...
      <div className="text-lg w-1/2" style={{ lineHeight: "50px" }}>
        ...
        <br />
        To enable us deliver this 25 done for you campaigns you're required to
        send us your login details by submitting a ticket here{" "}
        <a
