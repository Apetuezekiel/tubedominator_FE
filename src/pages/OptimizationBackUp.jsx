...
const Ideation = () => {
  ...
  useEffect(() => {
    ...
    const accessToken = googleAccessTokenRef.current.getAccessToken();
    console.log("accessTokeeeeeeeeeennnnnn", accessToken);
    ...
    const fetchDataFromAPI = async () => {
      ...
      try {
        ...
        console.log("fetchMyYoutubeInfo", response);
    ...
    const fetchMyPlaylists = async () => {
      ...
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_BASE_URL}/fetchMyPlaylists?email=${userRegEmail}`,
          {
            headers: {
              "Content-Type": "application/json",
              "x-api-key": process.env.REACT_APP_X_API_KEY,
