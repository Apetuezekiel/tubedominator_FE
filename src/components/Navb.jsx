...
// function Navb() {
//   return (
//     <Navbar id="navScroll" className="navbar navbar-expand-lg navbar-light fixed-top" tabIndex="0">
//       <Container>
//         <Navbar.Brand className="navbar-brand pe-4 fs-4" href="/">
//           <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-layers-half"
//             viewBox="0 0 16 16">
//             <path
...
//         <Navbar.Toggle className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
...
//             <Nav.Item>
//               <Nav.Link className="nav-link" href="#services" aria-label="Brings you to the frontpage">
//                 Services
//               </Nav.Link>
//             </Nav.Item>
//             <Nav.Item>
...
//             </Nav.Item>
//             <Nav.Item>
//               <Nav.Link className="nav-link" href="#numbers">
//                 Numbers
//               </Nav.Link>
//             </Nav.Item>
//             <Nav.Item>
...
//             </Nav.Item>
//             <Nav.Item>
//               <Nav.Link className="nav-link" href="#workwithus">
//                 Work with us
//               </Nav.Link>
//             </Nav.Item>
//             <Nav.Item>
...
//               className="bi bi-download ms-1" viewBox="0 0 16 16">
//               <path
