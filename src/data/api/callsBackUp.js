...
export const generateVideoSlides = async (video_id) => {
  if (!video_id) {
    console.error("Video Id wasnt passed to rendering engine");
    return null;
  }

  try {
    const response = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/generateSlides`,
      {
        video_id,
      },
      {
    ...
    if (response.data.success) {
      console.log("VIDEO SLIDES GENERATED SUCCESSFULLY", response.data.data);
      return response.data.data;
    } else {
      console.error("Error Generating Video slides:", response.data.error);
      return null;
    }
  } catch (error) {
...
export const renderVideo = async (video_id) => {
  ...
  try {
    const response = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/renderGenerateVideo`,
      {
        video_id,
      },
      {
    ...
    if (response.data.success) {
      console.log("VIDEO RENDERED SUCCESSFULLY", response.data.data);
      return response.data.data;
    } else {
      console.error("Error creating Video:", response.data.error);
      return null;
...
export const retrieveVideo = async (video_id) => {
  if (!video_id) {
    console.error("Video Id wasnt passed to Video retrieval engine");
    return null;
  }

  try {
    const response = await axios.post(
      `${process.env.REACT_APP_API_BASE_URL}/retrieveGeneratedVideo`,
      {
        video_id,
      },
      {
    ...
    if (response.data.success) {
      console.log("VIDEO RETRIEVED SUCCESSFULLY", response.data.data);
      return response.data.data;
    } else {
      console.error("Error Retrieving Video:", response.data.error);
      return null;
    }
  } catch (error) {
