...
// export const gridOrderStars = (props) => (
//   <div className='flex items-center justify-center' onClick={makeFavorite}>
//     <AiOutlineStar/>
//   </div>
// );

// export const gridOrderOptimizationLevel = (props) => {
//   return (
//     <div className="h-2 bg-gray-300 w-100 rounded-full flex flex-row">
//       <div className="w-80 bg-purple-600 rounded-full"></div>
//       <span className='w-20 text-sm text-purple-600'>20%</span>
//     </div>
//   );
// };
...
export const optimizationViews = (props) => (
  <button type="button" className="py-1 px-2 capitalize rounded-2xl text-xs">
    {props.Status}
  </button>
);
...
//     props.status === 'Hard' ? 'red' :
//     props.status === 'Easy' ? 'green' :
//     props.status === 'Medium' ? 'yellow' :
//     'transparent';
...
export const ordersGrid = [
  ...
  {
    headerText: React.createElement(AiOutlineStar),
    template: gridOrderImage,
    textAlign: "Left",
    width: "150",
  },
...
export const SavedIdeasData = [];

export const KeywordsProvidedGrid = [
  // {
  //   headerText: 'Image',
  //   template: gridOrderImage,
  //   textAlign: 'Center',
...
export const KeywordsProvidedData = [
  {
    OrderID: 10248,
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: <AiOutlineStar />,
    OrderItems: "Beginner's Guide to Web Development",
    Location: "USA",
    Status: "Easy",
    StatusBg: "#03C9D7",
    StatusBg: "#FB9678",
...
export const IdeationPageData = [
  {
    OrderID: 10248,
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: <AiOutlineStar />,
    OrderItems: "10 Tips for Better Smartphone Photography",
    Location: "USA",
    Status: "Easy",
    StatusBg: "#8BE78B",
    ProductImage: product6,
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 93.31,
    OrderItems: "10 Healthy Recipes for Weight Loss",
    Location: "New York",
    Status: "Hard",
    StatusBg: "#E73470",
    ProductImage: product7,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 93.31,
    OrderItems: "Building a Gaming PC on a Budget",
    Location: "Subscribers",
    Status: "Hard",
    StatusBg: "#E73470",
    ProductImage: product4,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 23.99,
    OrderItems: "Travel Vlog: Exploring the Streets of Barcelona",
    Location: "Spain",
    Status: "Easy",
    StatusBg: "#8BE78B",
    ProductImage: product1,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 95.99,
    OrderItems: "Mastering Adobe Photoshop: Essential Techniques",
    Location: "Easy",
    Status: "Easy",
    StatusBg: "#8BE78B",
    ProductImage: product2,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 17.99,
    OrderItems: "DIY Home Decor: Creating a Cozy Living Space",
    Location: "USA",
    Status: "Medium",
    StatusBg: "#FB9678",
    ProductImage: product3,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 59.99,
    OrderItems: "Intro to Artificial Intelligence: Concepts and Applications",
    Location: "Hard",
    Status: "Hard",
    StatusBg: "#E73470",
    ProductImage: product4,
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 87.99,
    OrderItems: "10 Essential Tools for Home Improvement Projects",
    Location: "USA",
    Status: "Easy",
    StatusBg: "#8BE78B",
    ProductImage:
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 122.99,
    OrderItems: "Creating Stunning Visual Effects in Adobe After Effects",
    Location: "Hard",
    Status: "Hard",
    StatusBg: "#E73470",
    ProductImage:
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 87.99,
    OrderItems: "Quick and Easy Recipes for Busy Individuals",
    Location: "USA",
    Status: "Medium",
    StatusBg: "#FB9678",
    ProductImage:
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 84.99,
    OrderItems: "Exploring Nature: Hiking Adventures in the Wilderness",
    Location: "Delhi",
    Status: "Medium",
    StatusBg: "#FB9678",
    ProductImage:
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 122.99,
    OrderItems: "10 Must-Have Gadgets for Tech Enthusiasts",
    Location: "USA",
    Status: "Easy",
    StatusBg: "#8BE78B",
    ProductImage:
  ...
  },
  {
    ...
    CustomerName: Math.floor(Math.random() * (10000 - 100) + 100),
    TotalAmount: 32.38,
    OrderItems: "10 Essential Photography Tips for Beginners",
    Location: "USA",
    Status: "Medium",
    StatusBg: "#FB9678",
    ProductImage: product6,
